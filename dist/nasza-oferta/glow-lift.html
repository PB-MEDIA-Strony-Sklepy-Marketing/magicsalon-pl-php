...
<head>
    ...
    <meta name="keywords" content="glow, lifting twarzy, pielęgnacja cery, zabiegi anti-aging, kosmetyka twarzy, Magic Salon">
    <meta name="author" content="MAGICSALON.pl - salon kosmetyczny">
    <meta name="robots" content="index">    
    <meta name="description" content="Zabieg Glow & Lift w MAGIC SALON – kompleksowa pielęgnacja skóry twarzy: oczyszczenie, regeneracja, lifting. Naturalny blask i odmłodzenie.">
    ...
    <title>Glow & Lift – MAGIC SALON | Pielęgnacja i lifting twarzy</title>
    
    <!-- Kanoniczny adres URL -->
    <link rel="canonical" href="https://magicsalon.pl/nasza-oferta/glow-lift.html" />

    <!-- Open Graph (Facebook, LinkedIn) -->
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Glow & Lift – MAGIC SALON | Pielęgnacja i lifting twarzy" />
    <meta property="og:description" content="Zabieg Glow & Lift w MAGIC SALON – kompleksowa pielęgnacja skóry twarzy: oczyszczenie, regeneracja, lifting. Naturalny blask i odmłodzenie" />
    <meta property="og:url" content="https://magicsalon.pl/nasza-oferta/glow-lift.html" />
    ...
    <meta name="twitter:description" content="Zabieg Glow & Lift w MAGIC SALON – kompleksowa pielęgnacja skóry twarzy: oczyszczenie, regeneracja, lifting. Naturalny blask i odmłodzenie." />
            ...
            <div class="wt-bnr-inr overlay-wraper" style="background-image:url(../images/banner/services.jpg);">
                ...
                <div class="container">
                    <div class="wt-bnr-inr-entry">
                        <h1 class="text-white">Glow & Lift – Blask i jędrność Twojej skóry w jednym zabiegu!</h1>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gray-light p-tb20">
            	<div class="container">
                    <ul class="wt-breadcrumb breadcrumb-style-2">
                        ...
                        <li><a href="glow-lift.html">Glow & Lift – Blask i jędrność Twojej skóry w jednym zabiegu!</a></li>
                    </ul>
                </div>
            </div>
            <!-- BREADCRUMB ROW END --> 
...
<script   src="../js/popper.min.js" defer async></script><!-- POPPER.MIN JS -->
<script   src="../js/bootstrap.min.js" defer async></script><!-- BOOTSTRAP.MIN JS -->
<script   src="../js/bootstrap-select.min.js" defer async></script><!-- FORM JS -->
<script   src="../js/jquery.bootstrap-touchspin.min.js" defer async></script><!-- FORM JS -->
<script   src="../js/magnific-popup.min.js" defer async></script><!-- MAGNIFIC-POPUP JS -->
<script   src="../js/waypoints.min.js" defer async></script><!-- WAYPOINTS JS -->
<script   src="../js/counterup.min.js" defer async></script><!-- COUNTERUP JS -->
<script   src="../js/waypoints-sticky.min.js" defer async></script><!-- COUNTERUP JS -->
<script   src="../js/isotope.pkgd.min.js" defer async></script><!-- MASONRY  -->
<script   src="../js/imagesloaded.pkgd.min.js" defer async></script><!-- MASONRY  -->
<script   src="../js/owl.carousel.min.js" defer async></script><!-- OWL  SLIDER  -->
<script   src="../js/scrolla.min.js" defer async></script><!-- ON SCROLL CONTENT ANIMTE   --> 
<script   src="../js/custom.js" defer async></script><!-- CUSTOM FUCTIONS  -->
<script   src="../js/shortcode.js" defer async></script><!-- SHORTCODE FUCTIONS  -->
...
<script  src="../plugins/revolution/revolution/js/jquery.themepunch.tools.min.js" defer async></script>
<script  src="../plugins/revolution/revolution/js/jquery.themepunch.revolution.min.js" defer async></script>

<!-- SLIDER REVOLUTION 5.0 EXTENSIONS  (Load Extensions only on Local File Systems !  The following part can be removed on Server for On Demand Loading) -->	
<script  src="../plugins/revolution/revolution/js/extensions/revolution-plugin.js" defer async></script>

<!-- REVOLUTION SLIDER FUNCTION  ===== -->
<script   src="../js/rev-script-1.js" defer async></script>
...
<script>
  ...
  function gtag(){dataLayer.push(arguments);}<!-- JAVASCRIPT  FILES ========================================= --> 
<script   src="../js/jquery-3.6.1.min.js"></script><!-- JQUERY.MIN JS -->
