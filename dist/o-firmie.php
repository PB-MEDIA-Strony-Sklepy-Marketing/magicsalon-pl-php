...
<head>
    ...
    <meta name="keywords" content="o salonie kosmetycznym, zespół beauty, kosmetolog, spa, zabiegi estetyczne, Magic Salon">
    <meta name="author" content="MAGICSALON.pl - salon kosmetyczny">
    <meta name="robots" content="index">
    <meta name="description" content="Poznaj historię i filozofię MAGIC SALON. Łączymy nowoczesne technologie i indywidualne podejście, byś mogła czuć się piękna i zadbana każdego dnia.">
    ...
    <meta name="twitter:title" content="O firmie – MAGIC SALON | Twoje piękno, nasza pasja" />
    <meta name="twitter:description" content="Poznaj historię i filozofię MAGIC SALON. Łączymy nowoczesne technologie i indywidualne podejście, byś mogła czuć się piękna i zadbana każdego dnia." />
...
<body id="bg">
                ...
                <div class="container">
                    ...
                    <div class="wt-topbar-right">
                        <ul class="social-bx list-inline">
                            <li><a href="https://www.facebook.com/magicsalonpl" class="fa-brands fa-facebook ikonascale" target="_blank"></a></li>
                            <li><a href="https://www.instagram.com/magicsalonpl" class="fa-brands fa-instagram ikonascale" target="_blank"></a></li>
                            <li><a href="https://www.tiktok.com/@magicsalonpl" class="fa-brands fa-tiktok ikonascale" target="_blank"></a></li>
                            <li><a href="https://wa.me/48883481581" class="fa-brands fa-whatsapp ikonascale" target="_blank"></a></li>
                            <li><a href="https://booksy.magicsalon.pl" class="fa iconcustom-booksyonlyicon iconcustom-lg" target="_blank"></a></li>
                        </ul>
                    </div>
    ...
    <div class="page-content">
        ...
        <div class="wt-bnr-inr overlay-wraper" style="background-image:url(images/banner/about-banner.jpg);">
            ...
            <div class="container">
                <div class="wt-bnr-inr-entry">
                    <h1 class="text-white">O firmie</h1>
                </div>
            </div>
        </div>
        ...
        <div class="section-full bg-gray p-b70">
            <div class="container">
                <!-- TITLE START-->
                <div class="section-head text-center">
                    <h1><span class="site-text-primary">Co</span> oferujemy?</h1>
                    <div class="wt-separator-outer">
                        <div class="wt-separator style-icon">
                            <i class="fa fa-leaf text-black"></i>
                            <span class="separator-left site-bg-primary"></span>
                    ...
                    <p>Nasza oferta obejmuje szerokie spektrum zabiegów kosmetycznych i estetycznych, w tym również zabiegi na pograniczu kosmetologii i medycyny estetycznej. Specjalizujemy się m.in. w:</p>
                </div>
                <!-- TITLE END-->
                <div class="section-content">
                    <div class="owl-carousel our-pricing-carousel owl-btn-vertical-center owl-btn-hover nav nav-tabs owl-loaded owl-drag">
                        ...
                        <div class="owl-stage-outer">
                            <div class="owl-stage" style="transform: translate3d(-1145px, 0px, 0px); transition: all; width: 2977px;">
                                <div class="owl-item cloned" style="width: 230px; margin-right: -1px;">
                                    <div class="item">
                                ...
                                <div class="owl-item active" style="width: 230px; margin-right: -1px;">
                                    <div class="item active-arrow active">
                                        <a data-bs-toggle="tab" href="#pricing-item1" class="tab-block">
                                            <div class="our-pricing-tab  radius-sm bdr-1 bdr-gray">
                                                <div class="wt-icon-box-wraper center p-lr10">
                                ...
                                <div class="owl-item cloned active" style="width: 230px; margin-right: -1px;">
                                    <div class="item active-arrow active">
                                        <a data-bs-toggle="tab" href="#pricing-item1" class="tab-block">
                                            <div class="our-pricing-tab  radius-sm bdr-1 bdr-gray">
                                                <div class="wt-icon-box-wraper center p-lr10">
                            ...
                            <div class="section-content p-t50">
                                ...
                                <div class="wt-tabs vertical bg-tabs">
                                    <ul class="nav nav-tabs" role="tablist">
                                        ...
                                        <li class="nav-item" role="presentation" style="display: none;"><a class="nav-link" data-bs-toggle="tab" href="#pricing-tab1-4" aria-selected="false" tabindex="-1" role="tab">Zabieg Lampą LED</a></li>
                                    ...
                                    <div class="tab-content p-l50">
                                        ...
                                        <div id="pricing-tab1-4" class="tab-pane" role="tabpanel" style="display: none;">
                                            <div class="pricing-tab-inner">
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-12">
                                                        <div class="wt-media">
                            ...
                            <div class="section-content p-t50">
                                ...
                                <div class="wt-tabs vertical bg-tabs">
                                    <ul class="nav nav-tabs" role="tablist">
                                        ...
                                        <li class="nav-item" role="presentation" style="display: none;"><a class="nav-link" data-bs-toggle="tab" href="#pricing-tab2-3" aria-selected="false" tabindex="-1" role="tab">Manicure</a></li>
                                    ...
                                    <div class="tab-content p-l50">
                                        ...
                                        <div id="pricing-tab2-3" class="tab-pane" role="tabpanel" style="display: none;">
                                            <div class="pricing-tab-inner">
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-12">
                                                        <div class="wt-media">
